...
export function ProposalCard({ proposal, onClick }) {
  ...
  return (
    <div
      className="w-full min-w-80 rounded-xl border border-gray-200 bg-white p-6 shadow-md"
    ...
    >
      ...
      {/* Itens da troca */}
      <div className="flew-row mb-4 flex items-center justify-between overflow-hidden rounded-xl bg-gray-50 p-4">
